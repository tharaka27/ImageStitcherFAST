...
void extractor(xf::Mat<TYPE, HEIGHT, WIDTH, NPC1> &_src,xf::Mat<XF_8UC1, 400, 528, XF_NPPC1> level_1,
	...
	float mvScaleFactor[8];
	float mvLevelSigma2[8];
	...
	float mvInvScaleFactor[8];
	float mvInvLevelSigma2[8];
	...
	xf::Point_<float> patternT[512];
	for (int i = 0; i < 1024; i += 2) {
		patternT[i / 2] = xf::Point_<float>(bit_pattern_31_[i], bit_pattern_31_[i + 1]);
	}

	//This is for orientation
	// pre-compute the end of a row in a circular patch
	int HALF_PATCH_SIZE = 15;
	int umax[HALF_PATCH_SIZE + 1];
	...
	//const int NPC1x = XF_NPPC1;
	//xf::Mat<XF_8UC1, 480, 640, NPC1x> level_0;
	//xf::Mat<XF_8UC1, 400, 528, XF_NPPC1> level_1;
	//xf::Mat<XF_8UC1, 444, 333, XF_NPPC1> level_2;
	//xf::Mat<XF_8UC1, 370, 278, XF_NPPC1> level_3;
	//xf::Mat<XF_8UC1, 309, 231, XF_NPPC1> level_4;
	//xf::Mat<XF_8UC1, 257, 193, XF_NPPC1> level_5;
